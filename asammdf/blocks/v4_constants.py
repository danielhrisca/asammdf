...
NON_SCALAR_TYPES = {
    ...
    DataEnum.DATA_TYPE_STRING_UTF_8,
    DataEnum.DATA_TYPE_STRING_LATIN_1,
    DataEnum.DATA_TYPE_STRING_UTF_16_BE,
    DataEnum.DATA_TYPE_STRING_UTF_16_LE,
    DataEnum.DATA_TYPE_CANOPEN_DATE,
    DataEnum.DATA_TYPE_CANOPEN_TIME,
}
...
SIGNED_INT = {DataEnum.DATA_TYPE_SIGNED_INTEL, DataEnum.DATA_TYPE_SIGNED_MOTOROLA}
FLOATS = {DataEnum.DATA_TYPE_REAL_INTEL, DataEnum.DATA_TYPE_REAL_MOTOROLA}
STANDARD_INT_SIZES = {8, 16, 32, 64}

INT_TYPES = {
    DataEnum.DATA_TYPE_UNSIGNED_INTEL,
    DataEnum.DATA_TYPE_UNSIGNED_MOTOROLA,
    DataEnum.DATA_TYPE_SIGNED_INTEL,
...
MASTER_TYPES = {ChannelEnum.CHANNEL_TYPE_MASTER, ChannelEnum.CHANNEL_TYPE_VIRTUAL_MASTER}
VIRTUAL_TYPES = {ChannelEnum.CHANNEL_TYPE_VIRTUAL, ChannelEnum.CHANNEL_TYPE_VIRTUAL_MASTER}


class ConversionEnum(IntEnum):
...
TABULAR_CONVERSIONS = {
    ConversionEnum.CONVERSION_TYPE_TABX,
    ConversionEnum.CONVERSION_TYPE_RTABX,
    ConversionEnum.CONVERSION_TYPE_TTAB,
    ConversionEnum.CONVERSION_TYPE_BITFIELD,
}

CONVERSIONS_WITH_TEXTS = {
    ConversionEnum.CONVERSION_TYPE_ALG,
    ConversionEnum.CONVERSION_TYPE_RTABX,
    ConversionEnum.CONVERSION_TYPE_TABX,
    ConversionEnum.CONVERSION_TYPE_TRANS,
    ConversionEnum.CONVERSION_TYPE_TTAB,
    ConversionEnum.CONVERSION_TYPE_BITFIELD,
}

CONVERSIONS_NUMERIC = {
    ConversionEnum.CONVERSION_TYPE_NON,
    ConversionEnum.CONVERSION_TYPE_LIN,
    ConversionEnum.CONVERSION_TYPE_RAT,
    ConversionEnum.CONVERSION_TYPE_ALG,
    ConversionEnum.CONVERSION_TYPE_TABI,
    ConversionEnum.CONVERSION_TYPE_TAB,
    ConversionEnum.CONVERSION_TYPE_RTAB,
}

CONVERSION_GROUP_1 = {ConversionEnum.CONVERSION_TYPE_NON, ConversionEnum.CONVERSION_TYPE_TRANS, ConversionEnum.CONVERSION_TYPE_TTAB}
...
class ChannelArrayEnum(IntEnum):
    CA_TYPE_ARRAY = 0
    CA_TYPE_SCALE_AXIS = 1
    CA_TYPE_LOOKUP = 2


class ChannelArrayStorageEnum(IntEnum):
...
class FlagDZ(IntFlag):
    FLAG_DZ_DEFLATE = 0
    FLAG_DZ_TRANPOSED_DEFLATE = 1


class FlagAT(IntFlag):
    FLAG_AT_EMBEDDED = 1
    FLAG_AT_COMPRESSED_EMBEDDED = 2
    FLAG_AT_MD5_VALID = 4

class FlagCA(IntFlag):
...
class FlagsCC(IntFlag):
    FLAG_CC_PRECISION = 1
    FLAG_CC_RANGE = 1 << 1


class FlagsHD(IntFlag):
    FLAG_HD_LOCAL_TIME = 1
    FLAG_HD_TIME_OFFSET_VALID = 2

# data location
class DataLocationEnum(IntEnum):
    LOCATION_ORIGINAL_FILE = 0
    LOCATION_TEMPORARY_FILE = 1
    LOCATION_MEMORY = 2

# data block type
class DataBlockEnum(IntEnum):
    DT_BLOCK = 0
    DZ_BLOCK_DEFLATE = 1
...
SINGLE_ATTACHMENT_CHANNEL_PARAMS_uf = struct.Struct(
    FMT_SINGLE_ATTACHMENT_CHANNEL_PARAMS
).unpack_from
SINGLE_ATTACHMENT_CHANNEL_PARAMS_u = struct.Struct(
    FMT_SINGLE_ATTACHMENT_CHANNEL_PARAMS
).unpack
