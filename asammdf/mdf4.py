...
from .utils import MdfException, get_fmt, fmt_to_datatype, pair, get_unique_name, get_min_max, fix_dtype_fields
                    ...
                    if len(shape) > 1:
                        ...
                        if len(names) == 1:
                            ...
                            for i in range(dims_nr):
                                kargs['dim_size_{}'.format(i)] = shape[::-1][i]
                        else:
