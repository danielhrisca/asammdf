...
*asamdf 2.5.0* was compared against *mdfreader 0.2.5* (latest versions from PyPI). 
...
.. plot::
    ...
    res = '../benchmarks/results/x64_asammdf_2.5.0_mdfreader_0.2.5.txt'
    topic = 'Open'
    aspect = 'time'
    for_doc = True
...
.. plot::
    ...
    res = '../benchmarks/results/x86_asammdf_2.5.0_mdfreader_0.2.5.txt'
    topic = 'Open'
    aspect = 'time'
    for_doc = True
