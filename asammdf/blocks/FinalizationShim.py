...
class MdfBlock():
    ...
    def load(self, stream: BinaryIO):
        ...
        :param stream:      BinaryIO for accessing the block data.
        :return:            None
        """
...
class CG_Block(MdfBlock):
    ...
    def is_vlsd(self):
        ...
        :return:        True if VLSD block, False otherwise.
        """
        return (self.flags & (1 << 0)) == 1
    
    @property
    def get_next_cg_block_address(self):
        """
        Get the next CG block address in this chain of CG blocks.
        :return:        The address of the next CG block, or 0 if none exists.
        """
        return self.links[0]
    
    @property
    def get_first_cn_block_address(self):
        """
        Get the first CN block address for this CG block.
        :return:        The address of the first CN block, or 0 if none exists.
        """
        return self.links[1]
...
class CN_Block(MdfBlock):
    ...
    def get_next_cn_block_address(self):
        ...
        :return:        The address of the next CN block, or 0 if none exists.
        """
        return self.links[0]
...
class DG_Block(MdfBlock):
    ...
    def get_next_dg_block_address(self):
        ...
        :return:        The address of the next DG block, or 0 if none exists.
        """
        return self.links[0]
    ...
    def get_cg_block_address(self):
        ...
        :return:        The address of the linked CG block, or 0 if none exists.
        """
        return self.links[1]
    ...
    def get_dt_block_address(self):
        ...
        :return:        The address of the linked DT block, or 0 if none exists.
        """
        return self.links[2]
...
class HD_Block(MdfBlock):
    ...
    def get_dg_block_address(self):
        ...
        :return:        The address of the linked DG block, or 0 if none exists.
        """
        return self.links[1]
...
class FinalizationShim:
    ...
    def _load_block(self, address: int):
        ...
        :param address:     The file address to load the block at.
