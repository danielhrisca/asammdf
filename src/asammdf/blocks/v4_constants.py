...
DZ_BLOCK_LZ = 3
DZ_BLOCK_LZ_TRANSPOSED = 4
DZ_BLOCK_ZSTD = 5
DZ_BLOCK_ZSTD_TRANSPOSED = 6

DZ_FLAG_TO_TYPE = {
    FLAG_DZ_DEFLATE: DZ_BLOCK_DEFLATE,
    FLAG_DZ_TRANSPOSED_DEFLATE: DZ_BLOCK_TRANSPOSED,
    FLAG_DZ_ZSTD:DZ_BLOCK_ZSTD,
    FLAG_DZ_TRANSPOSED_ZSTD: DZ_BLOCK_ZSTD_TRANSPOSED,
    FLAG_DZ_LZ4: DZ_BLOCK_LZ,
    FLAG_DZ_TRANSPOSED_LZ4: DZ_BLOCK_LZ_TRANSPOSED,
}
...
Version = Literal["4.00", "4.10", "4.11", "4.20", "4.30"]
