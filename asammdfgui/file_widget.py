...
class Ui_file_widget(object):
    def setupUi(self, file_widget):
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.channels_tab)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.channels_grid = QtWidgets.QGridLayout()
        self.channels_grid.setObjectName("channels_grid")
        self.plot_btn = QtWidgets.QPushButton(self.channels_tab)
        ...
        self.channels_grid.addWidget(self.plot_btn, 2, 0, 1, 1)
        self.channels_tree = QtWidgets.QTreeWidget(self.channels_tab)
        self.channels_tree.setObjectName("channels_tree")
        self.channels_tree.headerItem().setText(0, "1")
        self.channels_grid.addWidget(self.channels_tree, 1, 0, 1, 1)
        self.plot_scroll = QtWidgets.QScrollArea(self.channels_tab)
        self.plot_scroll.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.plot_scroll.setWidgetResizable(True)
        self.plot_scroll.setObjectName("plot_scroll")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 195, 493))
        ...
        self.channels_grid.addWidget(self.plot_scroll, 0, 1, 2, 1)
        self.channels_grid.setColumnStretch(1, 1)
        self.channels_grid.setRowStretch(1, 1)
        self.verticalLayout_2.addLayout(self.channels_grid)
        ...
        self.filter_layout.addWidget(self.filter_btn, 8, 1, 1, 1)
        self.line_7 = QtWidgets.QFrame(self.filter_tab)
        self.line_7.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_7.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_7.setObjectName("line_7")
        self.filter_layout.addWidget(self.line_7, 7, 1, 1, 2)
        spacerItem8 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.filter_layout.addItem(spacerItem8, 2, 3, 1, 1)
        self.filter_tree = QtWidgets.QTreeWidget(self.filter_tab)
        self.filter_tree.setObjectName("filter_tree")
        self.filter_tree.headerItem().setText(0, "1")
        self.filter_layout.addWidget(self.filter_tree, 1, 0, 9, 1)
        self.label_10 = QtWidgets.QLabel(self.filter_tab)
        self.label_10.setObjectName("label_10")
        self.filter_layout.addWidget(self.label_10, 6, 1, 1, 1)
        self.filter_split_size = QtWidgets.QDoubleSpinBox(self.filter_tab)
        self.filter_split_size.setObjectName("filter_split_size")
        self.filter_layout.addWidget(self.filter_split_size, 6, 2, 1, 1)
        ...
        self.filter_layout.addItem(spacerItem9, 9, 1, 1, 1)
        spacerItem10 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.filter_layout.addItem(spacerItem10, 4, 3, 1, 1)
        ...
        self.filter_layout.addItem(spacerItem11, 0, 1, 1, 1)
        ...
        self.filter_layout.addWidget(self.clear_filter_btn, 10, 0, 1, 1)
