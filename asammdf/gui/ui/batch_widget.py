...
class Ui_batch_widget(object):
    def setupUi(self, batch_widget):
        ...
        self.add_files_btn = QtWidgets.QPushButton(batch_widget)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/file.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add_files_btn.setIcon(icon)
        self.add_files_btn.setObjectName("add_files_btn")
        self.gridLayout_9.addWidget(self.add_files_btn, 0, 0, 1, 1)
        self.aspects = QtWidgets.QTabWidget(batch_widget)
        ...
        self.concatenate_btn.setIcon(icon1)
        ...
        self.aspects.addTab(self.concatenate_tab, icon1, "")
        ...
        self.aspects.addTab(self.scramble_tab, icon6, "")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/stack.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.stack_btn.setIcon(icon7)
        self.stack_btn.setObjectName("stack_btn")
        self.gridLayout_8.addWidget(self.stack_btn, 9, 1, 1, 1)
        self.aspects.addTab(self.stack_tab, icon7, "")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/open.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.load_can_database_btn.setIcon(icon8)
        ...
        self.gridLayout_9.addWidget(self.aspects, 0, 2, 3, 1)
        self.add_folder_btn = QtWidgets.QPushButton(batch_widget)
        self.add_folder_btn.setIcon(icon8)
        self.add_folder_btn.setObjectName("add_folder_btn")
        self.gridLayout_9.addWidget(self.add_folder_btn, 1, 0, 1, 1)
        ...
        self.files_list = ListWidget(batch_widget)
        self.files_list.setObjectName("files_list")
        self.gridLayout_9.addWidget(self.files_list, 2, 0, 1, 2)
    ...
    def retranslateUi(self, batch_widget):
        ...
        self.add_files_btn.setText(_translate("batch_widget", "Add files"))
        ...
        self.add_folder_btn.setText(_translate("batch_widget", "Add folder"))
