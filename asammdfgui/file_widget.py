...
class Ui_file_widget(object):
    def setupUi(self, file_widget):
        ...
        self.channels_tree = QtWidgets.QTreeWidget(self.verticalLayoutWidget)
        ...
        self.plot_scroll = QtWidgets.QScrollArea(self.splitter)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 52, 525))
