...
class Ui_PyMDFMainWindow(object):
    def setupUi(self, PyMDFMainWindow):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 782, 590))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 782, 590))
        ...
        self.gridLayout.addWidget(self.open_multiple_files_btn, 0, 0, 1, 1)
