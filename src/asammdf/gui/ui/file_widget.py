...
class Ui_file_widget(object):
    def setupUi(self, file_widget):
        ...
        self.channels_layout.setSpacing(3)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 310, 626))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 991, 602))
