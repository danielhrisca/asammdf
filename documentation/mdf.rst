...
This class acts as a proxy for the MDF_V2_V3 and MDF_V4 classes.
All attribute access is delegated to the underlying *_mdf* attribute (MDF_V2_V3 or MDF_V4 object).
See MDF_V2_V3 and MDF_V4 for available extra methods.
