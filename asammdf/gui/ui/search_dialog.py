...
class Ui_SearchDialog(object):
    def setupUi(self, SearchDialog):
        ...
        self.gridLayout_3.addItem(self.horizontalSpacer_3, 9, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.apply_pattern_btn, 9, 4, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.cancel_pattern_btn, 9, 1, 1, 1)
        ...
        QWidget.setTabOrder(self.apply_btn, self.add_window_btn)
        QWidget.setTabOrder(self.add_window_btn, self.match_kind)
        QWidget.setTabOrder(self.match_kind, self.tabs)
        QWidget.setTabOrder(self.tabs, self.raw)
        QWidget.setTabOrder(self.raw, self.filter_value)
        QWidget.setTabOrder(self.filter_value, self.filter_type)
        QWidget.setTabOrder(self.filter_type, self.define_ranges_btn)
        QWidget.setTabOrder(self.define_ranges_btn, self.apply_pattern_btn)
        QWidget.setTabOrder(self.apply_pattern_btn, self.cancel_pattern_btn)
        QWidget.setTabOrder(self.cancel_pattern_btn, self.pattern)
        QWidget.setTabOrder(self.pattern, self.pattern_match_type)
        QWidget.setTabOrder(self.pattern_match_type, self.name)
