...
class Ui_ChannelGroupDisplay(object):
    def setupUi(self, ChannelGroupDisplay):
        ...
        ChannelGroupDisplay.setMinimumSize(QSize(40, 35))
        ...
        self._icon.setMinimumSize(QSize(24, 24))
        self._icon.setMaximumSize(QSize(24, 24))
        self._icon.setBaseSize(QSize(24, 24))
