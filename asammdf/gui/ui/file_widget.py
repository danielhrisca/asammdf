...
class Ui_file_widget(object):
    def setupUi(self, file_widget):
        ...
        self.gridLayout_5.addItem(spacerItem8, 5, 0, 1, 1)
        ...
        self.consolidate_j1939.setChecked(True)
        self.consolidate_j1939.setObjectName("consolidate_j1939")
        self.gridLayout_8.addWidget(self.consolidate_j1939, 4, 0, 1, 2)
    ...
    def retranslateUi(self, file_widget):
        ...
        self.consolidate_j1939.setText(_translate("file_widget", "Consolidate J1939 (single group for all messages with common PGN)"))
