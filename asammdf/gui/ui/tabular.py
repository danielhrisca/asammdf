...
class Ui_TabularDisplay(object):
    def setupUi(self, TabularDisplay):
        ...
        self.gridLayout_2.addWidget(self.add_filter_btn, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.groupBox, 4, 0, 1, 8)
        ...
        self.gridLayout_2.addWidget(self.apply_filters_btn, 2, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.prefix, 2, 7, 1, 1)
