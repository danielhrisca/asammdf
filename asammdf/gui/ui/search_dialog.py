...
class Ui_SearchDialog(object):
    ...
    def retranslateUi(self, SearchDialog):
        ...
        self.selection.headerItem().setText(3, _translate("SearchDialog", "Source"))
        self.selection.headerItem().setText(4, _translate("SearchDialog", "Comment"))
        ...
        self.matches.headerItem().setText(3, _translate("SearchDialog", "Source"))
        self.matches.headerItem().setText(4, _translate("SearchDialog", "Comment"))
