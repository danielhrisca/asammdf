...
class Ui_batch_widget(object):
    def setupUi(self, batch_widget):
        ...
        self.consolidate_j1939 = QtWidgets.QCheckBox(self.extract_bus_tab)
        self.consolidate_j1939.setObjectName("consolidate_j1939")
        self.gridLayout_11.addWidget(self.consolidate_j1939, 2, 0, 1, 2)
    ...
    def retranslateUi(self, batch_widget):
        ...
        self.consolidate_j1939.setText(_translate("batch_widget", "Consolidated J1939 (single group for all messages with common PGN)"))
