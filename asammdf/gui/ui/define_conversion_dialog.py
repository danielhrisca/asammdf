...
class Ui_ConversionDialog(object):
    def setupUi(self, ConversionDialog):
        ...
        self.remove_btn = QPushButton(ConversionDialog)
        self.remove_btn.setObjectName(u"remove_btn")

        self.gridLayout.addWidget(self.remove_btn, 5, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.insert_btn, 1, 2, 1, 1)
        ...
        self.vtt_default = QLineEdit(self.tab_3)
        self.vtt_default.setObjectName(u"vtt_default")

        self.gridLayout_2.addWidget(self.vtt_default, 5, 1, 1, 1)

        self.vtt_list = MinimalListWidget(self.tab_3)
        self.vtt_list.setObjectName(u"vtt_list")

        self.gridLayout_2.addWidget(self.vtt_list, 1, 0, 4, 2)
        ...
        self.gridLayout_2.addWidget(self.reset_btn, 4, 2, 1, 1)
        ...
        self.vrtt_default = QLineEdit(self.tab_4)
        self.vrtt_default.setObjectName(u"vrtt_default")

        self.gridLayout_3.addWidget(self.vrtt_default, 4, 1, 1, 1)

        self.vrtt_list = MinimalListWidget(self.tab_4)
        self.vrtt_list.setObjectName(u"vrtt_list")

        self.gridLayout_3.addWidget(self.vrtt_list, 1, 0, 3, 2)
    ...
    def retranslateUi(self, ConversionDialog):
        ...
        self.remove_btn.setText(QCoreApplication.translate("ConversionDialog", u"Remove conversion", None))
        ...
        self.label.setText(QCoreApplication.translate("ConversionDialog", u"X -> Y (str) ", None))
        self.reset_btn.setText(QCoreApplication.translate("ConversionDialog", u"Reset", None))
        self.tabs.setTabText(self.tabs.indexOf(self.tab_3), QCoreApplication.translate("ConversionDialog", u"Value to Text", None))
        ...
        self.label_12.setText(QCoreApplication.translate("ConversionDialog", u"[ .. X .. )  -> Y (str) ", None))
        self.tabs.setTabText(self.tabs.indexOf(self.tab_4), QCoreApplication.translate("ConversionDialog", u"Value range to text", None))
