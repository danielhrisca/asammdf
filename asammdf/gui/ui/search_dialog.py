...
class Ui_SearchDialog(object):
    def setupUi(self, SearchDialog):
        ...
        self.canel_pattern_btn = QtWidgets.QTabWidget(SearchDialog)
        self.canel_pattern_btn.setObjectName("canel_pattern_btn")
        ...
        self.canel_pattern_btn.addTab(self.tab, "")
        ...
        self.gridLayout_3.addWidget(self.apply_pattern_btn, 7, 4, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.filter_value, 3, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.cancel_pattern_btn, 7, 1, 1, 1)
        spacerItem4 = QtWidgets.QSpacerItem(282, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_3.addItem(spacerItem4, 7, 3, 1, 1)
        ...
        self.pattern_match_type.addItem("")
        self.gridLayout_3.addWidget(self.pattern_match_type, 1, 2, 1, 1)
        ...
        self.filter_type.addItem("")
        self.filter_type.addItem("")
        self.gridLayout_3.addWidget(self.filter_type, 2, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.raw, 4, 2, 1, 1)
        self.gridLayout_3.setColumnStretch(3, 1)
        self.gridLayout_3.setRowStretch(4, 1)
        self.canel_pattern_btn.addTab(self.tab_2, "")
        self.gridLayout_2.addWidget(self.canel_pattern_btn, 0, 0, 1, 1)

        self.retranslateUi(SearchDialog)
        self.canel_pattern_btn.setCurrentIndex(0)
    ...
    def retranslateUi(self, SearchDialog):
        ...
        self.canel_pattern_btn.setTabText(self.canel_pattern_btn.indexOf(self.tab), _translate("SearchDialog", "Search"))
        ...
        self.canel_pattern_btn.setTabText(self.canel_pattern_btn.indexOf(self.tab_2), _translate("SearchDialog", "Pattern based window"))
