    ...
    * ``trigger`` - *Trigger* object for current group
    ...
    def configure(
        ...
        *,
        ...
        raise_on_mutiple_occurences=None,
    ):
        ...
        raise_on_mutiple_occurences : bool
        ...
        if from_other is not None:
            ...
            self._raise_on_mutiple_occurences = from_other._raise_on_mutiple_occurences
        ...
        if raise_on_mutiple_occurences is not None:
            self._raise_on_mutiple_occurences = bool(raise_on_mutiple_occurences)
