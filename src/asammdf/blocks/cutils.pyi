...
def get_channel_raw_bytes(data_block: bytes, record_size: int, byte_offset: int, byte_count: int) -> bytearray: ...
def get_invalidation_bits_array(
    data_block: bytes, invalidation_size: int, invalidation_pos: int
) -> NDArray[np.uint8]: ...
def get_channel_raw_bytes_parallel(
    data_block: bytes, record_size: int, signals: list[list[int]], thread_count: int = 11
) -> list[bytearray]: ...
